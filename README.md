...
> **Local test lab:** this repo also contains a fully local test setup (mock auth sites, test
> phishlets, Telegram notifications). See [LOCAL_SETUP.md](LOCAL_SETUP.md),
> [VPS_SETUP.md](VPS_SETUP.md) (deployment on Ubuntu 22/24 with a real domain) and
